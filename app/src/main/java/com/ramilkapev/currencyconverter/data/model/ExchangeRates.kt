...
/* Было два варианта реализации: через полный список рейтов или через Map.
    Через полный список мне не понравилось, как это выглядит: типа перечислять все рейти как-то не то,
    да и не работал этот вариант нормально (была ошибка no-args у gson'а)
 */
